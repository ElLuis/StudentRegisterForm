    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_program);
            ...
            programSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                @Override
                public void onNothingSelected(AdapterView<?> parent) {programInfoTV.setText("");
                }
            });
        }

        public void updateStudentProgram(int programCode)
        {
        ...
        public void updatePaymentAmount(int programCode)
        {
            db.open();
            boolean c = db.updateProgramTotalAmount(username,programCode,getTuitionFee(programCode));
            db.close();
        }
        ...
        public void registerBtn_OnClick(View view) {
            ...
            switch (programSelected)
            {
                case 0: // alter programCode = 3419
                    updateStudentProgram(3419);
                    //Insert Payment info
                    updatePaymentAmount(3419);
                    //Go to Payment Activity after adding balance
                    Intent intent = new Intent(ChangeProgramActivity.this,ChangePaymentActivity.class);
                    intent.putExtra("username",username);
                    startActivity(intent);
                    break;
                case 1:
                    //program code = 3408
                    updateStudentProgram(3408);
                    updatePaymentAmount(3408);
                    //Go to Payment Activity after adding balance
                    Intent intent1 = new Intent(ChangeProgramActivity.this,ChangePaymentActivity.class);
                    intent1.putExtra("username",username);
                    startActivity(intent1);
                    break;
                case 2: //programCode = 3506
                    updateStudentProgram(3506);
                    updatePaymentAmount(3506);
                    //Go to Payment Activity after adding balance
                    Intent intent2 = new Intent(ChangeProgramActivity.this,ChangePaymentActivity.class);
